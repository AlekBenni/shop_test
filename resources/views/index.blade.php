                        ...
                        <div class="caption">
                            ...
                            <p>
                                <form action="http://internet-shop.tmweb.ru/basket/add/1" method="POST">
                                    ...
                                    <input type="hidden" name="_token" value="jFpfMPrCRBVUfkntz6lTtX1HymjrEL2RzkZ5BHOE"> </form>
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="caption">
                            ...
                            <p>
                                <form action="http://internet-shop.tmweb.ru/basket/add/6" method="POST">
                                    Не доступен <a href="http://internet-shop.tmweb.ru/portable/gopro" class="btn btn-default" role="button">Подробнее</a>
                                    <input type="hidden" name="_token" value="jFpfMPrCRBVUfkntz6lTtX1HymjrEL2RzkZ5BHOE"> </form>
                            </p>
                        </div>
                    </div>
